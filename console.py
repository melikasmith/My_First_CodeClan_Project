...
city_1 = City("Istanbul", False, False, country_1)
city_repository.save(city_1)
city_2 = City("Izmir", False, False, country_1)
city_repository.save(city_2)
city_3 = City("Ankara", False, False, country_1)
city_repository.save(city_3)
city_4 = City("Konya", False, False, country_1)
city_repository.save(city_4)
city_5 = City("London", False, False, country_2)
city_repository.save(city_5)
city_6 = City("Manchester", False, False, country_2)
city_repository.save(city_6)
city_7 = City("Birmingham", False, False, country_2)
city_repository.save(city_7)
city_8 = City("Newcastle", False, False, country_2)
city_repository.save(city_8)
city_9 = City("Tokyo", False, False, country_3)
city_repository.save(city_9)
city_10 = City("Osaka", False, False, country_3)
city_repository.save(city_10)
city_11 = City("Kyoto", False, False, country_3)
city_repository.save(city_11)
city_12 = City("Hiroshima", False, False, country_3)
city_repository.save(city_12)
city_13 = City("Paris", False, False, country_4)
city_repository.save(city_13)
city_14 = City("Marseille", False, False, country_4)
city_repository.save(city_14)
city_15 = City("Nice", False, False, country_4)
city_repository.save(city_15)
city_16 = City("Lyon", False, False, country_4)
